...
const faqs = [
  { q: 'What are the check‑in and check‑out times?', a: 'Check‑in is 2:00 PM and check‑out is 11:00 AM.' },
  { q: 'Do you offer free cancellation?', a: 'Yes, selected rates offer free cancellation before 24 hours of arrival.' },
    ...
    <section className='py-16'>
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='text-center mb-8'>
          ...
          <p className='text-text-light mt-2'>Everything you need to know before you book</p>
        </div>
